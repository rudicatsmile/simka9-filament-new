...
class DataPegawaiFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'kode_unit_kerja' => $this->faker->numberBetween(1, 10),
            ...
            'kode_golongan_darah' => $this->faker->randomElement(['A', 'B', 'AB', 'O']),
            'kode_status_nikah' => $this->faker->randomElement(['001', '002', '003', '004']),
            'pstatus' => $this->faker->randomElement(['1', '0']),
            'kode_status_kepegawaian' => $this->faker->randomElement(['PNS', 'PPK', 'HON', 'KTR']),
            'blokir' => $this->faker->randomElement(['Tidak', 'Ya']),
            'alamat' => $this->faker->address(),
            'kode_propinsi' => $this->faker->randomElement(['001', '002', '003', '004', '005']),
            'kodepos' => $this->faker->numberBetween(10000, 99999),
            'alamat2' => $this->faker->optional()->address(),
            'kode_propinsi2' => $this->faker->optional()->randomElement(['001', '002', '003', '004', '005']),
            ...
            'kode_jabatan_utama' => $this->faker->randomElement(['001', '002', '003', '004', '005']),
            'unit_fungsi' => $this->faker->optional()->words(2, true),
            'unit_tugas' => $this->faker->optional()->words(2, true),
            'unit_pelajaran' => $this->faker->optional()->words(2, true),
            'mulai_bekerja' => $this->faker->dateTimeBetween('-30 years', '-1 year')->format('Y-m-d'),
            'kode_jenjang_pendidikan' => $this->faker->randomElement(['001', '002', '003', '004', '005']),
